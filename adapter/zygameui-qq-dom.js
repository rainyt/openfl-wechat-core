...
HTMLUtils.downloadTempFile = function(path,success,fail) {
	wx.downloadFile({ url : path, timeout : 60000, enableHttp2 : true, success : function(res) {
...
var WebSocket = $hx_exports["WebSocket"] = function(url,protocols) {
	...
	this._baseSocket = wx.connectSocket({ url : url, perMessageDeflate : false});
...
var Window = $hx_exports["Window"] = function() {
	...
	wx.showShareMenu({ showShareItems : ["qq","qzone"]});
	wx.onShareAppMessage(function() {
		return { title : "游戏还能这样玩？试试你的脑洞够不够！"};
	});
...
Window.main = function() {
	...
	if(window.performance == null || Window.platform != "devtools" && Window.platform != "ios") {
...
Window.listenerKeyEvent = function() {
	wx.onKeyDown(Window.onKeyDown);
	wx.onKeyUp(Window.onKeyUp);
};
